...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Widget _buildModule() {
    switch (_selectedIndex) {
      case 0: return AdminOverview(service: _service);
      case 1: return AdminUsers(service: _service);
      case 2: return AdminApps(service: _service);
      case 3: return AdminAnalytics(service: _service);
      case 4: return AdminComponents(service: _service);
      case 5: return AdminTemplates(service: _service);
      case 6: return AdminSecurity(service: _service);
      case 7: return AdminDeployment(service: _service);
      case 8: return AdminAi(service: _service);
      default: return AdminOverview(service: _service);
    }
  }

  String get _currentTitle =>
      _selectedIndex < _allItems.length
...
class StatusBadge extends StatelessWidget {
  ...
  Color get _color {
    switch (status.toLowerCase()) {
      case 'approved': case 'active': case 'published':
        return Colors.green;
      case 'rejected': case 'inactive': case 'deleted':
        return Colors.red;
