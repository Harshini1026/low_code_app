    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _Section(
          ...
          children: [
            _Toggle('Email / Password',  _emailAuth,
                (v) => setState(() => _emailAuth = v)),
            _Toggle('Google Sign-In',    _googleAuth,
                (v) => setState(() => _googleAuth = v)),
            _Toggle('Phone OTP',         _phoneAuth,
        ...
        _Section(
          ...
          children: [
            _Toggle('Two-Factor Authentication', _twoFactor,
                (v) => setState(() => _twoFactor = v)),
            _Toggle('Force HTTPS',               _forceHttps,
        ...
        _Section(
          ...
          children: [
            _AccessRow('Admin',       'Full access to all modules',
                Colors.purpleAccent),
            _AccessRow('User',        'App builder + own projects only',
                AppTheme.primary),
            _AccessRow('Guest',       'Read-only template preview',
                Colors.grey),
          ],
        ),
      ]),
