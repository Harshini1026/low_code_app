      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: ['all', 'draft', 'pending', 'approved',
                'rejected', 'published']
                .map((f) {
            ...
            children: [
              Text(name,
                  style: const TextStyle(
                      ...
                      fontSize:   13)),
              Text('Owner: ${userId.length > 12 ? userId.substring(0, 12) : userId}...',
                  style: const TextStyle(
  ...
  Future<bool> _confirm(BuildContext context, String appName) async =>
      await showDialog<bool>(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Text('Delete "$appName" permanently?',
              style: const TextStyle(
