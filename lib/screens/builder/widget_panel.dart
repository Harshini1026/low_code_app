...
const _categories = {
  'Basic': [
    ...
    {'type': 'richtext',  'label': 'Rich Text', 'icon': '✍',  'color': 0xFF9B59B6},
    ...
    {'type': 'container', 'label': 'Container', 'icon': '📦', 'color': 0xFF34495E},
  ],
  'Forms': [
    {'type': 'input',      'label': 'Text Field',     'icon': '📋', 'color': 0xFFE74C3C},
    {'type': 'multiline',  'label': 'Multi-line',     'icon': '📄', 'color': 0xFFC0392B},
    {'type': 'search',     'label': 'Search',         'icon': '🔍', 'color': 0xFFD35400},
    {'type': 'dropdown',   'label': 'Dropdown',       'icon': '▼',  'color': 0xFF9B59B6},
    {'type': 'multiselect','label': 'Multi-Select',   'icon': '☑',  'color': 0xFF1ABC9C},
    {'type': 'autocomplete','label': 'Autocomplete',  'icon': '💬', 'color': 0xFF2980B9},
    ...
    {'type': 'rangeslider','label': 'Range Slider',   'icon': '⊲⊳', 'color': 0xFFE67E22},
  ...
  'Layout': [
    ...
    {'type': 'expanded',   'label': 'Expanded',       'icon': '📏', 'color': 0xFF34495E},
  ...
  'Input Controls': [
    ...
    {'type': 'datepick',   'label': 'Date Picker',   'icon': '📅', 'color': 0xFF2980B9},
    {'type': 'timepick',   'label': 'Time Picker',   'icon': '🕒', 'color': 0xFF8E44AD},
    {'type': 'progress',   'label': 'Progress',       'icon': '📊', 'color': 0xFF27AE60},
    {'type': 'pincode',    'label': 'OTP/PIN',        'icon': '🔐', 'color': 0xFFE74C3C},
    {'type': 'signature',  'label': 'Signature',      'icon': '✍',  'color': 0xFF34495E},
  ],
  'Media': [
    ...
    {'type': 'gallery',    'label': 'Image Gallery',  'icon': '🖼',  'color': 0xFF2980B9},
    {'type': 'qrcode',     'label': 'QR Code',        'icon': '📲', 'color': 0xFF34495E},
    {'type': 'webview',    'label': 'Web View',       'icon': '🌐', 'color': 0xFF1ABC9C},
  ],
  'Feedback': [
    {'type': 'snackbar',   'label': 'Snackbar',       'icon': '💬', 'color': 0xFF16A085},
    ...
    {'type': 'bottomsheet','label': 'Bottom Sheet',   'icon': '📂', 'color': 0xFF8E44AD},
    {'type': 'loader',     'label': 'Loader',         'icon': '⌛', 'color': 0xFF27AE60},
    {'type': 'skeleton',   'label': 'Skeleton',       'icon': '░',  'color': 0xFF95A5A6},
  ],
  'Social & Auth': [
    {'type': 'googlelogin', 'label': 'Google Login',  'icon': '🔐', 'color': 0xFFDB4437},
    {'type': 'fblogin',    'label': 'Facebook Login', 'icon': '🔐', 'color': 0xFF4267B2},
    {'type': 'sharebutton','label': 'Share Button',   'icon': '↗',  'color': 0xFF1ABC9C},
    {'type': 'likebutton', 'label': 'Like Button',    'icon': '❤',  'color': 0xFFE74C3C},
    {'type': 'followbtn',  'label': 'Follow Button',  'icon': '➕', 'color': 0xFF3498DB},
    {'type': 'comment',    'label': 'Comment',        'icon': '💬', 'color': 0xFF16A085},
  ],
  'Navigation': [
    {'type': 'breadcrumb', 'label': 'Breadcrumb',     'icon': '▶', 'color': 0xFF2980B9},
    {'type': 'pagination', 'label': 'Pagination',     'icon': '«»', 'color': 0xFF34495E},
    {'type': 'menu',       'label': 'Menu',           'icon': '☰',  'color': 0xFF16A085},
    {'type': 'drawer',     'label': 'Drawer',         'icon': '📂', 'color': 0xFF8E44AD},
    {'type': 'navdrawer',  'label': 'Nav Drawer',     'icon': '🎯', 'color': 0xFF9B59B6},
  ],
  'Advanced': [
    {'type': 'accordion',  'label': 'Accordion',      'icon': '▼', 'color': 0xFF2980B9},
    {'type': 'timeline',   'label': 'Timeline',       'icon': '⟝', 'color': 0xFF27AE60},
    {'type': 'table',      'label': 'Data Table',     'icon': '🔲', 'color': 0xFF34495E},
    {'type': 'segcontrol', 'label': 'Segment Control','icon': '⊞', 'color': 0xFFE67E22},
    {'type': 'emptystate', 'label': 'Empty State',    'icon': '📭', 'color': 0xFF95A5A6},
    {'type': 'errorstate', 'label': 'Error State',    'icon': '❌', 'color': 0xFFE74C3C},
  ],
};
